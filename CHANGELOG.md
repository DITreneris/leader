...
### Changed
- **GitHub Actions:** bumped official actions to Node.js 24–compatible tags per [Node 20 runner deprecation](https://github.blog/changelog/2025-09-19-deprecation-of-node-20-on-github-actions-runners/): `actions/checkout@v6`, `actions/setup-node@v5`, `actions/configure-pages@v5.0.1`, `actions/upload-pages-artifact@v4`, `actions/deploy-pages@v4.0.6` in `.github/workflows/deploy.yml` and `ci.yml`.
