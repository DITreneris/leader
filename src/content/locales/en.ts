export const enCopy = {
    ...
    heroBento: {
      ariaLabel: "Proof of the output shape: before and after.",
      chipOne: "Before → after",
      chipTwo: "Output shape",
      chipThree: "Decision-grade",
      title: "Stop reading noise. Start shipping briefs.",
      subtitle: "The page is static. The result shape is the point.",
      beforeLabel: "Before",
      beforeTitle: "Status theatre",
      beforeBullets: ["Five topics, ten opinions", "No decision question", "No owner, no deadline"],
      afterLabel: "After",
      afterTitle: "Decision brief",
      afterBullets: ["One decision + criteria", "Top risks + trade-off", "Owner + deadline + next action"],
      ownerChipLabel: "Owner",
      ownerChipValue: "Named (not “everyone”)",
      deadlineChipLabel: "Deadline",
      deadlineChipValue: "Written (not “ASAP”)",
      helper: "You fill context once, copy one module prompt, and get this brief shape every time—then run the same safety check before sending.",
    },
    practiceSafety: {
...
- ...`,
    ...
    safety: {
      ...
      title: "Same gate as step 4—full prompt to copy.",
      subtitle: "Four ordered checks before board, client, partner, or team sees the text.",
    ...
    library: {
      ...
      subtitle: "Depth last: open one workflow when you need it.",
      starter: {
    ...
    systemVisual: {
      eyebrow: "Reference · how the OS fits",
