export const ltCopy = {
    ...
    heroBento: {
      ariaLabel: "Išvesties formos įrodymas: prieš ir po.",
      chipOne: "Prieš → po",
      chipTwo: "Išvesties forma",
      chipThree: "Sprendimo lygis",
      title: "Nustok skaityti triukšmą. Pradėk siųsti briefus.",
      subtitle: "Puslapis statinis. Esmė – rezultato forma.",
      beforeLabel: "Prieš",
      beforeTitle: "Statuso teatras",
      beforeBullets: ["5 temos, 10 nuomonių", "Nėra sprendimo klausimo", "Nėra savininko ir termino"],
      afterLabel: "Po",
      afterTitle: "Sprendimo briefas",
      afterBullets: ["Vienas sprendimas + kriterijai", "Top rizikos + kompromisas", "Savininkas + terminas + kitas veiksmas"],
      ownerChipLabel: "Savininkas",
      ownerChipValue: "Įvardytas (ne „visi“)",
      deadlineChipLabel: "Terminas",
      deadlineChipValue: "Užrašytas (ne „ASAP“)",
      helper:
        "Kontekstą įvedi vieną kartą, kopijuoji vieną modulio promptą ir visada gauni tokią brief’o formą—tada prieš siunčiant paleidi tą pačią saugumo patikrą.",
    },
    practiceSafety: {
