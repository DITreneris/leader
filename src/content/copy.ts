...
export const uiCopy = {
  en: {
    ...
    flowScheme: {
      ...
      bridgeNote:
        "Same blocks as practice below: role, context, decision logic, output, then the 30-second safety check.",
      inputLabel: "Input",
      inputExample:
  ...
  lt: {
    ...
    flowScheme: {
      ...
      bridgeNote:
        "Tie patys blokai kaip praktikoje žemiau: rolė, kontekstas, sprendimo logika, išvestis, tada 30 sek. saugumo patikra.",
      inputLabel: "Įvestis",
      inputExample:
