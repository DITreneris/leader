...
1. **Fog:** capture the messy meeting, report, decision, delegation, or message.
2. **Structure:** ask for decision, trade-off, risk, questions, owner, deadline, and output format.
...
- **15-45 min:** move executive intent into a delegation brief the team can execute.
